                        ...
                        <form method="POST" action="../../../server/utilitarianismAnalysis.php">
                            <div>
                                ...
                                <div class = "box has-text-weight-bold">
                                    ...
                                    <input type="range" min="1" max="10" value="5" class="slider" id="Stakeholer4-1">
                                ...
                                <div class = "box has-text-weight-bold">
                                    ...
                                    <input type="range" min="1" max="10" value="5" class="slider" id="Stakeholer4-2">
                                    <span class="range-value">5</span>  
                                ...
                                <div class="box has-text-weight-bold">
                                    ...
                                    <input type="range" min="1" max="10" value="5" class="slider" id="Stakeholer4-3">
                                    <span class="range-value">5</span>  
                                ...
                                <div class="box has-text-weight-bold">
                                    ...
                                    <input type="range" min="1" max="10" value="5" class="slider" id="Stakeholer4-4">
                                    <span class="range-value">5</span> 
