        ...
        function setAnswers(){
            try{
                ...
                while ($row = $result1 -> fetch()){
                    ...
                    $slider = $row['2-long-slider'];
                    $ex = $row['2-long-ex'];
                    $pleasure = $row['2-long-pleasure'];
                ...
                if (isset($_POST['o2-long'])){
                    for ($i = 1; $i <= $count; $i++){
                        ...
                        $update1 = "UPDATE `stakeholders` SET `2-long-slider`= ".$sliderVal." ,`2-long-ex`= '".$exVal."',`2-long-pleasure`= '".$pleasureVal."' WHERE name = '".$namearray[$i-1]."' and uid = ".$uid."";
                        $pdo -> query($update1);
                ...
                <div class="column is-two-thirds">
                    ...
                    <div>
                        ...
                        <form method="POST">
                            ...
                            <br>
                            <button class = "button" name="o2-long">Submit</button>
                        </form>
                        ...
                        <a href= "utilitarianism-analysis4.php"><button class = "button is-primary" id = "option4" >Option 2 - Long-term</button>  </a>
                    </div>
