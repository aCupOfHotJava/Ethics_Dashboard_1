<?php
    ...
    function getOption(){
        try {
            ...
            echo '<p class="subtitle is-5 has-text-centered">'.$namearray[1].'</p>';
        }
        ...
        function setAnswers(){
            try{
                ...
                while ($row = $result1 -> fetch()){
                    ...
                    $slider = $row['2-short-slider'];
                    $ex = $row['2-short-ex'];
                    $pleasure = $row['2-short-pleasure'];
                ...
                if (isset($_POST['o2-short'])){
                    for ($i = 1; $i <= $count; $i++){
                        ...
                        $update1 = "UPDATE `stakeholders` SET `2-short-slider`= ".$sliderVal." ,`2-short-ex`= '".$exVal."',`2-short-pleasure`= '".$pleasureVal."' WHERE name = '".$namearray[$i-1]."' and uid = ".$uid."";
                        $pdo -> query($update1);
...
<!------------------------------------------------------------------------------------------------>
    ...
    <html>
        <head>
            <title>Utilitarianism - Analyses - Option 2</title>
                ...
                <div class="column is-two-thirds">
                    ...
                    <div>
                        ...
                        <form method="POST">
                            ...
                            <br>
                            <button class = "button" name="o2-short">Submit</button>
                        </form>
                        ...
                        <a href= "utilitarianism-analysis3.php"><button class = "button is-primary" id = "option3" >Option 2 - Short-term</button>  </a>
