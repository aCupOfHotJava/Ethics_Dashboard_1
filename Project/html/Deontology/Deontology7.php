...
<?php
    ...
    function determineState() {
        ...
        try{
            ...
            $uid = $_SESSION["uid"];
            $sql = "SELECT yesOrNo1 ,option1, yesOrNo2 ,option2  FROM deontology7 WHERE uid = '" .$uid ."';";
            ...
            if(isset($_POST['submit_option1'])) {
                ...
                if($isEmpty) {
                    ...
                    $stmt = $pdo -> prepare("INSERT INTO deontology7(uid,yesOrNo1, option1,yesOrNo2,option2) VALUES ('" .$uid ."', '" .$yesOrNo1 ."','" .$option1 ."','" .$yesOrNo2 ."', '" .$option2 ."');");
                    ...
                    $stmt = $pdo -> prepare("UPDATE deontology7 SET yesOrNo1 = '" .$yesOrNo1 ."',option1 = '" .$option1 ."',yesOrNo2 = '" .$yesOrNo2 ."' ,option2 = '" .$option2 ."' WHERE uid = " .$uid .";");
                ...
                <?php
                    ...
                    <div class = "options">
                        <div class = "box" id = "dilemma-box">
                            ...
                            <textarea class = "textarea required" name="option1" id = "option1-2" placeholder = "Revealing the truth is right in all circumstances, times and all places."></textarea>
                        ...
                        <div class = "box" id = "dilemma-box">
                            ...
                            <textarea class = "textarea required" name="option2" id = "option1-2" placeholder = "A world governed by this moral law would be untenable. Concealment is necessary to form relationships, engage in contracts and protect valuable things."></textarea>
