...
$("#add-option").click(function() {
    $("#ethics-options-wrapper").append('<textarea id = "option-text" class = "textarea" placeholder = "Enter your text here."></textarea>');
    $("#empty").remove();
    $("#add-option").hide();
    ...
    $("#submit-option").click(function() {
        ...
        var text = $('textarea#option-text').val();
